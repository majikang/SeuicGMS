                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="dep_id">
                                @foreach($departs as $depart)
                                    <option value="{{$depart['id']}}" @if($depart['id'] == $user->dep_id) selected="selected" @endif>
                                        {{ $depart['html'] }}{{ trans($depart['name']) }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
